...
# require_relative 'open_addressing_linear_probe'
#
# RSpec.describe OpenAddressingLinearProbe, type: Class do
#   let(:star_wars_movies) { OpenAddressingLinearProbe.new(6) }
#
#   before do
...
#       hash = OpenAddressingLinearProbe.new(4)
#       hash["key"] = "value"
...
#       hash = OpenAddressingLinearProbe.new(1)
#       hash["key"] = "value"
...
#       inception = OpenAddressingLinearProbe.new(1)
...
#       movies = OpenAddressingLinearProbe.new(6)
...
RSpec.describe '#Algo Evaluation storing ascending numbers' do
  h = OpenAddressingLinearProbe.new(8)
  1..(15000).times do |e|
    h[e.to_s] = e
    if e % 100 == 0
